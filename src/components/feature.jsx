    ...
    return (
        <div className="w-full bg-black">
                ...
                <div className="feature-2-2 text-end">
                    ...
                    <div className="feature-browsing-6_1">
                        ...
                        <input
                            ...
                            type="text"
                            className="feature-browsing-6-2"
                            placeholder="Enter Your Email"
                        />
                    </div>
                </div>
            </div>
            <div className="feature-3-1">Helping you focus</div>
            <div className="feature-3-2">What really matters</div>
            <div className="feature-3-3">
                Browser-based platform, we aim to make creators accessible to a wide range of users,
                regardless
            </div>
            ...
            <div className="feature-3-5">
                ...
                <button className="feature-3-5-2 feature-hover" onClick={effect}>
                    Schedule Demo
                </button>
            </div>
            <div className="feature-3-6">Compatible with all</div>
            <div className="feature-3-7">Major tools</div>
            <div className="feature-3-8">
                We supports all most used asset design tools, making it easy to integrate into your
                workflow. Its
            </div>
            <div className="feature-3-9">
            ...
            <div className="feature-3-14">
                ...
                <button className="feature-3-14-3 feature-hover" onClick={effect}>
                    Contact Us
                </button>
            </div>
