        ...
        <div className=" bg-black w-full overflow-hidden   ">
            ...
            <div className="flex lg:justify-between xl:justify-between justify-center xs:flex-col ss:flex-col sm:flex-col md:flex-col relative mx-32 xl:mx-44 sm:mx-16 ss:mx-14 xs:mx-10 lg:mt-20 lg:mb-64 xl:mt-20 xl:mb-64 mb-20  ">
                ...
                <div className="feature-2-2 flex flex-col justify-center items-center lg:items-end lg:text-end xl:items-end xl:text-end text-center">
                    <div className="text-[96px] font-encodeSans  md:text-[100px] sm:text-[80px] ss:text-[65px] xs:text-[45px] md:leading-[120px] sm:leading-[100px] ss:leading-[85px] xs:leading-[60px]  xs:mb-6 font-bold text-[#E3E3E3]">
            ...
            <div className=" mx-32 xl:mx-44 sm:mx-16 ss:mx-14 xs:mx-10 lg:pt-20 xl:pt-20 ">
                <div className="feature-3-1 font-encodeSans lg:text-left xl:text-left text-center  md:text-[110px] sm:text-[100px] ss:text-[80px] xs:text-[45px]  md:leading-[120px] sm:leading-[100px] ss:leading-[85px] xs:leading-[60px] ">
                ...
                <div className="flex justify-between xs:flex-col ss:flex-col sm:flex-col md:flex-col  items-center">
                    <img src={Feature2} className="" alt="image" />
                    <button
                ...
                <div className="flex flex-col justify-end  items-center  text-center lg:items-end lg:text-right lg:my-24 xl:items-end xl:text-right xl:mt-24 mt-20 ">
                    <div className="feature-3-6 font-encodeSans md:text-[110px] sm:text-[100px] ss:text-[80px] xs:text-[45px] md:leading-[120px] sm:leading-[100px] ss:leading-[85px] xs:leading-[60px]">
            ...
            <div className="my-0 flex lg:flex-row xl:flex-row flex-col min-h-[70vh] xs:min-h-[80vh]  gap-5 mx-32 xl:mx-44 sm:mx-16 ss:mx-14 xs:mx-10">
            ...
            <div className="flex justify-center relative my-96 xs:my-52   items-center mx-32 xl:mx-44 sm:mx-16 ss:mx-14 xs:mx-10">
                <div className="feature-3-14 feature-bg rounded-[20px] absolute z-[0] h-[551px] xs:h-[300px] w-full  flex flex-col justify-center items-center ">
                    <div className="feature-3-14-1 z-[1] md:text-[110px] sm:text-[100px] ss:text-[80px] xs:text-[36px] absolute top-[140px] xs:top-20  leading-[0]  uppercase text-[#D0DBFF] font-fira tracking-wide ">
                        Metaverses
                    </div>
                    <div className="feature-3-14-2 z-[1] md:text-[44px] sm:text-[36px] ss:text-[28px] xs:text-[16px] absolute top-[180px] xs:top-28 font-fira tracking-wide  text-[#D0DBFF] uppercase">
